...
<BR><BR>
   ...
   <%--  <sql:setDataSource
    ...
    <sql:query var="listUsers"   dataSource="${myDS}">
        ...
        SELECT DATE_FORMAT(upload_date,'%d-%m-%Y') AS upload_date,head,file_path,"Download File" AS FILE,DATE_FORMAT(date_time,'%d-%m-%Y %H:%i:%s') AS date_time FROM upload_master WHERE DATE_FORMAT(upload_date,'%d-%m-%Y')='<%= date%>' and head='PROVISIONAL' ORDER BY date_time desc
    
    </sql:query>
     
    <div align="center">
        <table border="1" cellpadding="5">
            <h2>List of Provisional Final Files Uploaded By DPL on <%= date%> </h2>
            <tr>
                <th>File</th>
