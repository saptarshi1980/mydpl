...
<div class="header">
 ...
 <table width="427" border="2" align="center" cellpadding="2" bgcolor="#5882FA">
   <tr>
     <td width="415"><div align="center" class="style2">PROVISIONAL FINAL SCHEDULE DATA UPLOAD </div></td>
   </tr>
 </table>
<div align="center">
  <p>&nbsp;</p>
...
<blockquote><blockquote><form name="form1" method="post" action="UploadFileOther" enctype="multipart/form-data" onsubmit="return CheckFileName()">
