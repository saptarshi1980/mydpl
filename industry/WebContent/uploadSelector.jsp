...
<div class="header">
 ...
 <table width="427" border="2" align="center" cellpadding="2" bgcolor="#5882FA">
   <tr>
     <td width="415"><div align="center" class="style2">Data Upload </div></td>
   </tr>
 </table>
<div align="center">
  <p>&nbsp;</p>
...
<blockquote><blockquote><form name="form1" method="post" action="UploadController">
<table width="298" border="2" align="center" cellpadding="2">
         
         <tr>
           <td width="284"><input type="radio" NAME="a" value="Initial Upload" checked>Initial Uplaod</td>
         </tr>
         <tr>
           <td width="284"><input type="radio" NAME="a" value="Provisional Upload" >Provisional Final Upload</td>
         </tr>
         <tr>
           <td align="center">
