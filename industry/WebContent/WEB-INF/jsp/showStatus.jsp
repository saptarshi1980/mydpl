...
<body >
   ...
   <a href='index.jsp'><span>Home</span></a><BR><BR>
    <sql:setDataSource
        var="myDS"
    ...
    <sql:query var="listUsers"   dataSource="${myDS}">
    	...
    	%>
        SELECT a.temp_con_no,a.conn_load,a.conn_phase,a.unit_name,a.unit_address1,a.unit_address2,a.unit_pincode,a.unit_landmark,a.unit_landline,a.unit_mobile,a.applicant_fname,a.applicant_lname,a.applicant_address1,a.applicant_address2,a.applicant_pincode,a.applicant_landline,a.applicant_mobile,a.name_ref1,a.address_ref1,a.name_ref2,a.address_ref2,a.entry_date,B.Agreement,B.BOM_prep,B.clearance_elect,B.connection,B.Demand_note,B.Demand_rate,B.job_cmpl_cert,B.message,B.rcpt_app_form,B.security_deposit,B.commercial_clearance,B.site_inspection,B.work_order,B.BOM_ISSUANCE,DATE_FORMAT(B.date_1,'%d-%m-%Y') as date_1,DATE_FORMAT(B.date_2,'%d-%m-%Y') as date_2,DATE_FORMAT(B.date_3,'%d-%m-%Y') as date_3,DATE_FORMAT(B.date_4,'%d-%m-%Y') as date_4,DATE_FORMAT(B.date_5,'%d-%m-%Y') as date_5,DATE_FORMAT(B.date_6,'%d-%m-%Y') as date_6,DATE_FORMAT(B.date_7,'%d-%m-%Y') as date_7,DATE_FORMAT(B.date_8,'%d-%m-%Y') as date_8,DATE_FORMAT(B.date_9,'%d-%m-%Y') as date_9,DATE_FORMAT(B.date_10,'%d-%m-%Y') as date_10,DATE_FORMAT(B.date_11,'%d-%m-%Y') as date_11,DATE_FORMAT(B.date_12,'%d-%m-%Y') as date_12 FROM new_consumer a,con_status B WHERE TRIM(a.temp_con_no)='<%= conNumber%>' AND a.temp_con_no=B.temp_con_no
    </sql:query>
...
<div align="center">
       ...
       <br><br>
       <A HREF="AppRcptCons">Click Here To Generate Your Application Receipt</A><br><br>
       <A HREF="annex.pdf" target="_blank">List of Documents To Be Submitted</A><br><br>
       <A HREF="ANNEXURE_A.pdf" target="_blank">Annexure A</A><br><br>
 	   <A HREF="Guidline.pdf" target="_blank">Guideline</A>
