...
<table width="657" height="658" border="1" align="center" cellpadding="2" bgcolor="#CCCCFF">
  <tr>
  ...
  <tr>
    <td colspan="4" bgcolor="#CC99CC"><div align="center" class="style1 style3">General Information of the Industry Unit </div></td>
  </tr>
  <tr>
    <td colspan="2">Load (KVA) Applied for </td>
    <td colspan="2"><label>
  ...
  <tr>
    <td colspan="2">Phone Number (Land Line) </td>
