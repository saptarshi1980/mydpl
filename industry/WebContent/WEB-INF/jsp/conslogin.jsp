...
<form id="form1" name="form1" method="POST" action="ConsAuth" >
  <div align="center">
    <p>&nbsp;</p>
    <table width="621" height="319" border="2" bordercolor="#993300">
      <tr>
        <td height="248" bgcolor="#99CC99"><div align="center">
          <p><strong><span class="style10">CONSUMER LOGIN </span><br>
        ...
        <font color="red"><%=p%></font> </div></td>
      </tr>
      <tr>
        <td height="61" bgcolor="#99CC99"><div align="center">
            <p>New User?<A Href="NewConnHandlerPage">Click Here to Register </A></p>
            </div></td>
      </tr>
    </table>
     <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</p>
