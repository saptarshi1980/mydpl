...
<title>Deptt of Power-Login</title>
<!-- <style type="text/css">
<!--
body {
...
<form id="form1" name="form1" method="POST" action="PowerDepttAuth" >
  <div align="center">
    <p>&nbsp;</p>
    <table width="621" height="256" border="2" bordercolor="#993300">
      <tr>
        <td height="248" bgcolor="#99CC99"><div align="center">
            <p><strong><span class="style10"> Login-Power Department, Govt of West Bengal</span><br>
