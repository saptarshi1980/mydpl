...
<a href="RedirectShowNewCons"><span>New Consumer Home</span></a>
<br>
<br>
...
<BR>
    ...
    %>
    <%
			String imageUrl = request.getContextPath()+"/imgs/cal.gif";
...
<div align="center">
        <form name="form1" method="post" onsubmit="return checkDate()" action="UpdateHandler" >
        ...
        <p align="left">&nbsp;</p>
        <table width="655" border="1" align="left" cellpadding="2">
          <tr>
            <td width="212">Phase</td>
            <td width="423"><label>
              <select name="select">
                <option>Receipt of Completed Application Form</option>
                <option>Site Inspection</option>
                <option>Commercial Clearance </option>
                <option>Preparation of BOM </option>
                <option>Job Completion Certificate received ? </option>
                <option>Issuance of Demand rate for Supervision Charges Service Charges </option>
                <option>Issuance of Demand Note for Security Deposit </option>
                <option>Receipt of Security Deposit </option>
                <option>Agreement</option>
                <option>Clearance from Electrical Inspector(For HT Consumer only) </option>
                <option>Connection</option>
                <!-- <option>Message For The Consumer</option> -->
          ...
          <tr>
            <td>Change Date (DD/MM/YYYY)</td>
            <td><input name="date" id="date" type="text" size="12" onblur=""></td>
          </tr>
          <tr>
            <td>Amount</td>
            <td><label>
              <input name="amt" type="text" size="12">
            </label></td>
          </tr>
          <tr>
