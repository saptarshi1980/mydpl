...
<br><br>
      ...
      <div id="templatemo_left_column">
        ...
        <p class="style3">&nbsp;</p>
        <p class="style3">&nbsp;</p>
        <p class="style4">You have returned to DPL's Payment Portal.</p>
        <p class="style3">&nbsp;</p>
        <p class="style3"><span class="style5">Click here to view</span> <a href="PaymentStatus?ref_no=${requestScope.ref_no}"><strong>Payment Status/Payment Receipt</strong></a> </p>
      </div>
