...
<div class="title" align="center">Generate Payment Receipt</div>
<form name="frm1" action="GenerateRcpt.dpl" method="post">
<p>
<p><br>
<table width="305" height="90" border="1" align="center" >
  ...
  <tr>
    <td height="51" colspan="2" bgcolor="#6699CC">
      <div align="center">
        <input name="name" type="submit"  id="name" value="Proceed" style="width:120px; height:25px;"/>
    </div></td></tr>
</table>
<br>
<div align="center"></div>
