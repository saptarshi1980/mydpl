...
<%
request.getSession().setAttribute("valid", "Y");
%>
...
<div class="title" align="center">Welcome to Online Bill Payment System</div>
...
<table width="305" height="90" border="1" align="center" >
  <td width="221"><div align="center"><span class="style3">Consumer id</span></div></td>
    <td width="68"><input name="con_id" type="text" id="con_id" style="font-size: 14pt" size="12"/></td>
  ...
  <tr>
    <td height="51" colspan="2" bgcolor="#6699CC">
      <div align="center">
        <input name="name" type="submit"  id="name" value="Proceed For Payment" style="width:120px; height:25px;"/>
    </div></td></tr>
    	...
    	<div id="templatemo_right_column">
            ...
            <ul class="templatemo_menu">
              <li><a href="QuickPay">Homepage</a></li>
               <li><a href="QuickReceipt" target="_parent">Generate Payment Receipt</a></li>
              <li><a href="http://thedpl.in/updateinfo">Update Mobile No & Email Id  </a></li>
              <li><a href="faq.jsp" target="_blank">Frequently Asked Questions</a></li>
              <!-- <li><a href="#">Link</a></li>
