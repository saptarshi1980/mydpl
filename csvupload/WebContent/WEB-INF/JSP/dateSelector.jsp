...
<title>The Durgapur Projects Limited</title>
    ...
    <script>
  $(function() {
    $( "#date" ).datepick({dateFormat:"dd-mm-yyyy"}).val();
...
<div class="header">
 ...
 <table width="427" border="2" align="center" cellpadding="2" bgcolor="#5882FA">
   <tr>
     <td width="415"><div align="center" class="style2">PAYMENT DETAILS CSV UPLOAD </div></td>
   </tr>
 </table>
<div align="left">
  <p><a href="HistoryHandler"><span>Click Here for Upload History</span></a></p>
