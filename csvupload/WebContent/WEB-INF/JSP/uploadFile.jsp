...
.style2 {
  ...
  function CheckFileName() {
        ...
        if (fileName == "") {
            alert("Browse to upload a valid File with .csv or .txt extension");
            return false;
        }
            ...
            alert("File with " + fileName.split(".")[1] + " is invalid. Upload a validfile with .csv or .txt extensions");
            return false;
        }
        return true;
    }
...
<div class="header">
 ...
 <table width="427" border="2" align="center" cellpadding="2" bgcolor="#5882FA">
   <tr>
     <td width="415"><div align="center" class="style2">PAYMENT INFORMATION CSV UPLOAD </div></td>
   </tr>
 </table>
<div align="center">
  <p>&nbsp;</p>
...
<table width="365" border="2" align="center" cellpadding="2">
         ...
         <td>
           <div align="center">Upload Date: 
             ...
             <%
			        String date = request.getSession().getAttribute("date").toString().trim();
    	...
    	%>
         ...
         <tr>
           <td align="center"><div align="center">Select CSV File :
